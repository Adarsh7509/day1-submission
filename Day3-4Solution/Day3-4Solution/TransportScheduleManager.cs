...
namespace Day3_4Solution
{
    ...
    {
        private readonly List<TransportScheduleManager> schedules = new();

        public void AddSchedule(TransportScheduleManager schedule) => schedules.Add(schedule);

        public IEnumerable<TransportScheduleManager> Search(string type = null, string route = null, DateTime? departure = null) =>
        ...
        public IEnumerable<IGrouping<string, TransportScheduleManager>> GroupByTransportType() => schedules.GroupBy(s => s.TransportType);
    ...
    public class TransportApp
    {
        ...
        {
            var schedule = new TransportScheduleManager
            {
